...
public class InMemoryProductRepository implements ProductRepository {
	...
	public InMemoryProductRepository() {
		...
		Product tablet_Nexus = new Product("P1236", "Nexus 7", new BigDecimal(
				300));
		tablet_Nexus
				.setDescription("Google Nexus 7 is the lightest 7 inch tablet With a quad-core Qualcomm Snapdragon™ S4 Proprocessor");
	...
	public Set<Product> getProductsByFilter(Map<String, List<String>> filterParams) {
		...
		System.out.println("productsByBrand: "+productsByBrand.toString());
		...
		System.out.println("productsByCategory: "+productsByCategory.toString());
		return productsByCategory;
	}
